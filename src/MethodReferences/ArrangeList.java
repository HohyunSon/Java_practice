...
class ArrangeList {
    public static void main(String[] args) {
        ...
        Consumer<List<Integer>> c = Collections::reverse;	// 람다식
...
과게에는 코드 자체에 대한 가독성을 중시하는 분위기였다. 따라서 읽기 쉬운 코드라면 양이 조금 늘어나도
...
그리고 만약에 Collections 클래스의 다음 메소드를 몰랐다면, 위와 같이 간단한 람다식의 작성은
불가능했을 것이다.
...
즉 static 메소드의 참조 방법은 다음과 같다. 그리고 아래에서 ::은 자바 8에서 추가된, 메소드 참조를
의미하는 연산자이다.
...
위의 '메소드 참조'에서 람다식에는 있는 인자 전달에 대한 정보를 생략할 수 있는 이유는 다음 약속에
근거한다.
