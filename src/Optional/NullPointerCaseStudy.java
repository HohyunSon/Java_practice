...
코드를 작성해야 하는데, 이는 어렵지는 않지만 매우 번거로운 일이다. 그래서 이러한 일을 단순히 처리할 수 있도록 자바 8에서
Optional 클래스가 소개되었다.
...
이 방법이 가장 무나하다. 그런데 반갑게도 이러한 상황을 개선할 수 있도록 자바 8에서 Optional 클래스가
소개되었다.

Optional 클래스를 공부한다는 것은
Optional 클래스를 공부하면 세련된 코드를 즐겁게 작성할 수 있다. 그러나 늘 그렇듯 세련된 코드를 작성하려면
그만큼 더 알아야 한다.
*/