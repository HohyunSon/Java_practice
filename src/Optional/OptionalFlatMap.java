...
위 예제에서 보이는 다음 두 문장을 비교하자. 이 두 문장의 비교를 통해 flatMap을 이해할 수 있따.
...
그렇다면 flatMap은 언제 유용하게 사용할 수 있을까? 다음 예제에서(FlatMapElseOptional.java) 보이듯이 Optional 인스턴스를
클래스의 멤버로 두는 경우에 유용하게 사용할 수 있다.
*/