...
class HowHashCode{
    public static void main(String[] args) {
        HashSet<Car2> set = new HashSet<>();
        set.add(new Car2("HY_MD_301", "RED"));
        set.add(new Car2("HY_MD_301", "BLACK"));
        set.add(new Car2("HY_MD_302", "RED"));
        set.add(new Car2("HY_MD_302", "WHITE"));
        set.add(new Car2("HY_MD_301", "BLACK"));
