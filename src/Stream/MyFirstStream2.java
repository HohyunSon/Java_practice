...
/*
	...
	그리고 예제에서 호출한 filter와 sum은 IntStream의 인스턴스 메소드이다. 따라서 다음과 같이 스트림의
	생성과 그에 따른 연산의 과정을 하나의 문장으로 완성할 수 있다.
    ...
    최종 연산이 생략되면 그전에 아무리 많은 중간 연산을 진행했다 하더라도 의미가 없다. 쉽게 말해서
    아무런 결과도 보이지 않는다.
